...
rabbitmq/certs/server_rabbitmq_certificate.pem: server-certificate
	...
	cp -vf tls-gen/basic/result/ca_certificate.pem rabbitmq/certs
	cp -vf tls-gen/basic/result/server_rabbitmq_certificate.pem rabbitmq/certs
	cp -vf tls-gen/basic/result/server_rabbitmq_key.pem rabbitmq/certs
